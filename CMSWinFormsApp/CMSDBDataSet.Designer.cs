...
namespace CMSWinFormsApp {
    ...
    public partial class CMSDBDataSet : global::System.Data.DataSet {
        ...
        public partial class tblCustomerDataTable : global::System.Data.TypedTableBase<tblCustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public tblCustomerRow AddtblCustomerRow(string CarNo, string Name, string Addresss, string Make) {
        ...
        public partial class tblCustomerRow : global::System.Data.DataRow {
            ...
            public string Addresss {
                get {
                    try {
                        return ((string)(this[this.tabletblCustomer.AddresssColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Addresss\' in table \'tblCustomer\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tabletblCustomer.AddresssColumn] = value;
                }
            }
            ...
            public bool IsAddresssNull() {
                return this.IsNull(this.tabletblCustomer.AddresssColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetAddresssNull() {
                this[this.tabletblCustomer.AddresssColumn] = global::System.Convert.DBNull;
            }
...
namespace CMSWinFormsApp.CMSDBDataSetTableAdapters {
    ...
    public partial class tblCustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[tblCustomer] WHERE (([CarNo] = @Original_CarNo) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Addresss = 1 AND [Addresss] IS NULL) OR ([Addresss] = @Original_Addresss)) AND ((@IsNull_Make = 1 AND [Make] IS NULL) OR ([Make] = @Original_Make)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tblCustomer] ([CarNo], [Name], [Addresss], [Make]) VALUES (@Ca" +
                "rNo, @Name, @Addresss, @Make);\r\nSELECT CarNo, Name, Addresss, Make FROM tblCusto" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tblCustomer] SET [CarNo] = @CarNo, [Name] = @Name, [Addresss] = @Addresss, [Make] = @Make WHERE (([CarNo] = @Original_CarNo) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Addresss = 1 AND [Addresss] IS NULL) OR ([Addresss] = @Original_Addresss)) AND ((@IsNull_Make = 1 AND [Make] IS NULL) OR ([Make] = @Original_Make)));
SELECT CarNo, Name, Addresss, Make FROM tblCustomer WHERE (CarNo = @CarNo)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CarNo, Name, Addresss, Make FROM dbo.tblCustomer";
        ...
        public virtual int Delete(string Original_CarNo, string Original_Name, string Original_Addresss, string Original_Make) {
        ...
        public virtual int Insert(string CarNo, string Name, string Addresss, string Make) {
            if ((CarNo == null)) {
        ...
        public virtual int Update(string CarNo, string Name, string Addresss, string Make, string Original_CarNo, string Original_Name, string Original_Addresss, string Original_Make) {
            if ((CarNo == null)) {
                throw new global::System.ArgumentNullException("CarNo");
            }
            else {
            ...
            if ((Original_Addresss == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(Original_Addresss));
            }
            if ((Original_Make == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Addresss, string Make, string Original_CarNo, string Original_Name, string Original_Addresss, string Original_Make) {
            return this.Update(Original_CarNo, Name, Addresss, Make, Original_CarNo, Original_Name, Original_Addresss, Original_Make);
        }
    }
